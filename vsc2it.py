...
ANSI_COLORS = {"Ansi 0 Color": "terminal.ansiBlack",
...
def main():
    ...
    for color_index in range(16):
        ...
        itermcolors[key] = {"Red Component": hex2rgbcomponents(theme["colors"][ANSI_COLORS[key]].lstrip("#"))[0], "Green Component": hex2rgbcomponents(
            theme["colors"][ANSI_COLORS[key]].lstrip("#"))[1], "Blue Component": hex2rgbcomponents(theme["colors"][ANSI_COLORS[key]].lstrip("#"))[2], "Color Space": "sRGB"}

    itermcolors["Background Color"] = {"Red Component": hex2rgbcomponents(theme["colors"]["editor.background"].lstrip("#"))[0], "Green Component": hex2rgbcomponents(
        theme["colors"]["editor.background"].lstrip("#"))[1], "Blue Component": hex2rgbcomponents(theme["colors"]["editor.background"].lstrip("#"))[2], "Color Space": "sRGB"}
